                                    ...
                                    <form class="" action="<?php echo base_url('Agent/AgentReportDateMonth');?>" method="post" novalidate target="_blank">
                                        ...
                                        <div class="col-md-3"><!--start--->
                                          <div class="field item form-group">
                                              ...
                                              <label class="col-form-label col-md-1 col-sm-3  label-align">Form Date<span class="required">*</span></label>
                                              <div class="col-md-3 ">
                                                <input type="date" class="form-control has-feedback-left" id="" name="fromdate">
                                              </div>


                                              <label class="col-form-label col-md-1 col-sm-3  label-align">To Date<span class="required">*</span> 
                                              </label>
                                              <div class="col-md-3 ">
