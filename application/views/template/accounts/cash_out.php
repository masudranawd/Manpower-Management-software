              ...
              <ul class=" navbar-right" style="text-align: center;">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <center> <botton type="button" class="btn btn-round btn-info btn-block" style="font-size: 22px;">Cash Out </botton></center>
                      ...
                      <table class="table table-striped jambo_table bulk_action" style="width: 100%;">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title" style="text-align: center;">Voucher No</th>
                      ...
                      <?php 
                          ...
                          $totalEx = 0;
                            foreach ($AllPaymentData as $PaymentData) {
                              ...
                              if($PaymentData->payment_type == 'Expense'){
                              $sl++;
                          ...
                          <tr class="even pointer">
                            ...
                            <?php }elseif($PaymentData->employ_id == !null){
                              ?>
                                <?php  
                                  $EmployData = $this->Accounts_model->Employee_info_for_invoice($PaymentData->employ_id);
                                    echo $EmployData->name;
                              ?>
                            ...
                            <td style="text-align: center;"><?php echo $PaymentData->for_payment;?></td>
                            <td style="text-align: center;"><?php echo $PaymentData->voucher_no;?></td>
...
<!--- model end ----->
        ...
        <tr style="height: 400px;">
          <form action="<?php echo base_url('Accounts/AddNewCashOutPayment');?>" method="post" >
        ...
        $(this).find("option:selected").each(function(){
            ...
            if(optionValue){
               ...
               <td style="width: 15%;">
                ...
                <div class="field item form-group Employee box1" style="margin-top: -8px;">
                   <select class="chosent form-control pay" name="employ_id" style="height: 300px;" >
                      <option value="" >Select Employee</option> 
                        <?php  foreach ($AllEmployeeData as $EmployeeData) { ?>
                          <option value="<?php echo $EmployeeData->id;?>"> <?php echo $EmployeeData->employ_id;?> / <?php echo $EmployeeData->name;?> 
                          </option>
                     <?php  }  ?>
                    </select>
                 <script type="text/javascript">$(".chosent").chosen(); </script>
               ...
               <td style="width: 9%;">
                   <div class="field item form-group">
                      <div class="col-md-12">
                        <input  class="form-control pay" type="text" name="voucher_no" placeholder="Voucher" >
                      </div>
                    </div>
               </td>
...
<!--start--->
               ...
               <td style="width: 10%;">
                   <div class="field item form-group">
                        <input  class="form-control pay" type="text" name="expense_payment" placeholder="enter Amount">
                   </div>
               </td>
               <td style="width: 10%;">
                  <div class="field item form-group">
...
<tr>
  <td colspan="10" style="text-align: right;">Total Cash IN = <?php echo   $totalEx;?></td>
  <td colspan="2" ></td>
</tr>
...
<form action="<?php //echo base_url('Accounts/DailyPayAdd/');?><?php  //echo $PaymentData->id;?>/<?php // echo $PaymentData->pay_id;?>" method="post">
        <input type="text" name="id" value="<?php //echo $PayDate->id;?>">
          <div class="field item form-group">
            <label class="col-form-label col-md-12 col-sm-3  label-align" style="color:green;font-size: 1.3rem;font-weight: 900;text-align: center;">  Are You Sure ? Your Ladger Completed . </label>
         </div>     

          <div class="field item form-group">
            <label class="col-form-label col-md-12 col-sm-3  label-align">  
                <input type="text" name="" class="form-control" value="Total Debit =<?php// echo $totalpay;?>">
            </label>
         </div>     

          <div class="field item form-group">
            <label class="col-form-label col-md-12 col-sm-3  label-align">  
                <input type="text" name="" class="form-control" value="Total Cradit =<?php //echo $totalEx;?>">
            </label>
         </div>     

          <div class="field item form-group">
            <label class="col-form-label col-md-12 col-sm-3  label-align">  
                <input type="text" name="" class="form-control" value="Total Profit =<?php// echo (int)$totalpay - (int)$totalEx;?>">
            </label>
         </div>     
