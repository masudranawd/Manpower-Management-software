                      ...
                      <div class="row invoice-info" >
                        ...
                        <div class="col-sm-3 invoice-col">
                          ...
                          <address>
                                          ...
                                          <strong>Agent Name:
                                          <?php 
                                          $AgentInfo = $this->Accounts_model->Agent_info_for_invoice($InvoiceData->agent_id);
                       
                                        //  if($AgentInfo->agent_name){ echo $AgentInfo->agent_name;}else{'';} 
                                          ...
                                          if($AgentInfo->agent_id){ echo $AgentInfo->agent_id;}else{'';} 
                                          ?>
                                          ...
                                          if($AgentInfo->mobile_no){ echo $AgentInfo->mobile_no;}else{'';} 
                                          ?>
                                      </address>
                        </div>
