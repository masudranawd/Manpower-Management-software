            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel"  style="background:#fff;">
                  <div class="x_title">
                    <h2 style="color:#000;">Receive Category Report</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                      <div class="row">
                          <div class="col-md-12">
                            ...
                            <div class="" style="color:#000;font-weight: bold; ">
                                ...
                                <div class="col-md-4">
                                     <p style="font-size:22px;padding:0px; margin:0px;">Receive Category Report</p>
                                      

                                     <p style="padding:0px; margin:0px;"><?php 
                                      $cat_data = $this->Account_model->GetDataReciverPayMethod($cat_id);
                                      if ($cat_data  == !null) {
                                          echo '<b>Name: </b>.' .$cat_data->name; 
                                      }else{
                                        echo '';
                                      }
                                     ?>   
                                  ...
                                  <?php
                                      ...
                                      $receivetotal = 0;
                                      $expensetotal = 0;
                                    foreach ($PaymentReceiveCatReportlist as $PayReceiveCatReportData) {
                                    
                                      $sl++;$receivetotal =(int)$receivetotal+(int)$PayReceiveCatReportData->pay_amount;
                                      $expensetotal =(int)$expensetotal+(int)$PayReceiveCatReportData->cost_amount;
                                    }
                                  ?>
                    ...
                    <table class="table table-striped table-bordered" style="width:100% margin-top:40px;" >
                      ...
                      <?php
                        ...
                        foreach ($PaymentReceiveCatReportlist as $PayReceiveCatReportData) {
                          ...
                          $sl++;$dtotal =(int)$dtotal+(int)$PayReceiveCatReportData->pay_amount;
                          $ctotal =(int)$ctotal+(int)$PayReceiveCatReportData->cost_amount;
                      ?>
                        <tr>
                          <td><?php echo $sl;?></td>
                          <td><?php echo date("d/m/Y", strtotime($PayReceiveCatReportData->payment_date));?></td>    
                          <td>
                           <!-- dectiption -->

                            <?php  
                                $AgentInfo = $this->Accounts_model->Agent_info_for_invoice($PayReceiveCatReportData->agent_id);
                                   if ($AgentInfo == !null) {
                            ...
                            ?> 
                            <?php  
                                  $CustomerInfo = $this->Accounts_model->Customer_info_for_invoice($PayReceiveCatReportData->customer_id);
                            ...
                            <?php echo $PayReceiveCatReportData->remark;?>
                            
                          </td>    
                          <td>

                                <?php 
                                    $receivecatgory = $this->Account_model->GetDataBycatMethod( $PayReceiveCatReportData->cat_id);
                                ...
                                <?php 
                                    $Expensecatgory = $this->Account_model->GetDataByExpenseCatMethod( $PayReceiveCatReportData->expense_id);
                          ...
                          <td>
                                ...
                                <?php 
                                    $pay_method_data = $this->Account_model->GetDataByPayMethod( $PayReceiveCatReportData->payment_method_id);
                          ...
                          <td style="width:13%;text-align: right;"><?php echo $PayReceiveCatReportData->pay_amount;?></td>
                        </tr>
                      <?php
                        }
                      ?>
