                    ...
                    <table id="datatable" class="table tablewhite table-striped table-bordered" style="width:100%">
                      ...
                      ?>
                        ...
                        ?>
                            <br/>
                            <?php 
                              $catData = $paylist->cat_id; 
                              $pay_for_data = $this->Account_model->GetDataReciverPayMethod($catData);
                              if ($pay_for_data ==!null) { echo $pay_for_data->name; }
                          ...
                          <td><?php echo $paylist->pay_amount;?>
                          ...
                          <td style="width:30%;">
                            ...
                            <a href="<?php echo base_url('Account/ReceiveEdit/');?><?php echo $paylist->id;?>" class="btn btn-round btn-warning btn-xs">Edit</a>
...
<form action="<?php echo base_url('Account/PayRemove/')?><?php echo $paylist->id;?>" method="post">
