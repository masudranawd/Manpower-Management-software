          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>New Customer<?php echo $this->session->flashdata('sms');?></h2>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                        <form class="" action="<?php echo base_url('Status/NewCustomerStatusUpdateByPage');?>/<?php echo $CustomerData->id;?>" method="post" novalidate>
